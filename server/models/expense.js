...
function Expense(documentDBClient, databaseId, collectionId) {
...
Expense.prototype = {
    ...
    updateItem: function (itemId, expense, callback) {
        var self = this;
        ...
        self.getItem(itemId, function (err, doc) {
            if (err) {
                ...
                self.client.replaceDocument(doc._self, expense, function (err, replaced) {
                    if (err) {
                        callback(err);
